      ...
      <Carousel className="h-full !rounded-none" indicators={true}>
        {slides.map((slide, idx) => (
          ...
          >
            ...
            <div className="absolute top-0 left-0 w-40 h-40 bg-accent/20 rounded-full blur-3xl -translate-x-20 -translate-y-20 pointer-events-none" />

            {/* Decorative Accent - Bottom Right */}
            <div className="absolute bottom-0 right-0 w-40 h-40 bg-secondary/20 rounded-full blur-3xl translate-x-20 translate-y-20 pointer-events-none" />

            {/* Content */}
            <div className="relative z-10 text-center px-4 sm:px-8 max-w-4xl mx-auto">
              {/* University Logo Badge (optional) */}
              <div className="mb-6 inline-flex items-center gap-2 bg-white/10 backdrop-blur-md rounded-full px-4 py-2 border border-accent/30">
