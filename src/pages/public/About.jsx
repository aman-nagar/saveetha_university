            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-muted text-lg leading-relaxed">
                  ...
                  degree we grant is a global passport to success.
                </p>
              </motion.div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-gray-50 p-8 rounded-[2.5rem] space-y-4 hover:bg-primary hover:text-white transition-all duration-500 group">
                  ...
                  <p className="text-sm opacity-70">
                    Technologically integrated classrooms and high-speed
                    research labs.
                  </p>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-px bg-white/10">
            <div className="p-16 space-y-6 hover:bg-white/5 transition-colors">
              ...
              <p className="text-white/70 text-lg font-light leading-relaxed">
                ...
                commitment. We prepare young minds to solve real-world
                challenges with creativity and compassion.
              </p>
            </div>
            <div className="p-16 space-y-6 hover:bg-white/5 transition-colors">
              ...
              <p className="text-white/70 text-lg font-light leading-relaxed">
                To provide transformative education through experiential
                learning and interdisciplinary research, equipping students to
                excel in their global careers.
              </p>
            </div>
          </div>
        </section>
