    ...
    <div style="width: 210mm; height: 297mm; position: relative; background: white; font-family: Arial, sans-serif; color: #000;">
      ...
      <div style="position: relative; z-index: 10; padding: 2.3in 0.4in 0.5in 0.4in;">
        <table style="width: 100%; font-size: 11px; font-weight: bold; border-collapse: collapse; margin-bottom: 20px;">
          <tr>
            ...
            <td style="width: 40%; padding: 4px 0;">${(resultData.candidate_name || resultData.student_name || '').toUpperCase()}</td>
          ...
          <tbody>
            ${(resultData.subjects || [])
              ...
              <tr style="height: 30px; vertical-align: middle;">
                ...
                <td style="border-left: 1px solid #000; border-right: 1px solid #000; padding: 6px; text-align: left;">${sub.subject_name || ''}</td>
        ...
        <div style="margin-top: 30px;">
          <table style="width: 100%; border-collapse: collapse; border: 1.5px solid #000; font-size: 8px; text-align: center; table-layout: fixed;">
            ...
            <tbody>
              <tr style="height: 32px;">
                ...
                ${[1, 2, 3, 4, 5, 6, 7, 8]
                  .map((num) => {
                    const record = cumulativeHistory.find((h) => Number(h.duration) === num);
          ...
          <div style="margin-top: 12px; font-size: 12px; font-weight: bold; color: #000;">Total in Word : &nbsp; <span style="font-weight: 900;">${resultData.grand_overall_details?.total_in_words || ''} Only</span></div>
        </div>
      </div>
      ...
      <div style="position: absolute; bottom: 0.8in; left: 0.4in; right: 0.4in; display: flex; justify-content: space-between; align-items: flex-end; z-index: 20;">
        ...
        <div style="text-align: center; width: 2.2in;">
          <div style="height: 40px; font-size: 9px; font-style: italic; color: rgba(0,0,0,0.2); margin-bottom: 5px;">University Seal [cite: 95]</div>
